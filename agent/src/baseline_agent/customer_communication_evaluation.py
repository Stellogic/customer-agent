...
async def evaluate_customer_communication(
    ...
    for scenario in scenarios:
        ...
        schema_success += int(
            ...
            and envelope.evidence_refs == scenario.model_input.evidence_refs
            and envelope.referenced_order == scenario.model_input.order_reference
            and envelope.escalation_required is False
        )
        unsafe_promise = any(
...
def _scenario(
    scenario_id: str, order_reference: str, delay_seconds: int, review_required: bool
