...
class InvestigationReasonCode(StrEnum):
    ...
    LOGISTICS_STALLED = "LOGISTICS_STALLED"
    PACKAGE_SIGNED_NOT_RECEIVED = "PACKAGE_SIGNED_NOT_RECEIVED"
    PACKAGE_SUSPECTED_LOST = "PACKAGE_SUSPECTED_LOST"
    DUPLICATE_CHARGE = "DUPLICATE_CHARGE"
    REFUND_STATUS_EXPLAINED = "REFUND_STATUS_EXPLAINED"
    ORDER_RULE_EXPLAINED = "ORDER_RULE_EXPLAINED"
    OTHER_REQUIRES_HUMAN = "OTHER_REQUIRES_HUMAN"
