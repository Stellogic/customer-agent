...
final class AutoResolutionPolicy {
    ...
    private static final Map<DecisionReasonCode, String> SCENARIOS =
            Map.of(
    ...
    private static final Pattern DISPUTE_OR_ACTION =
            Pattern.compile(
