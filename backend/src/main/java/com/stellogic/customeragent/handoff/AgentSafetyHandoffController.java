...
final class AgentSafetyHandoffController {
    ...
    @PostMapping("/safe-handoff")
    @ResponseStatus(HttpStatus.ACCEPTED)
    AgentSafetyHandoffResult request(
            ...
            @RequestBody AgentSafetyHandoffBody body) {
        ...
        return service.requestAgentSafetyHandoff(new RequestAgentSafetyHandoff(
    ...
    record AgentSafetyHandoffBody(AgentSafetyHandoffReason reasonCode, AgentSafetyHandoffSummary summary) {}
}
