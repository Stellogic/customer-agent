...
record SupportAssistanceRequest(
        UUID assignmentId, UUID requestId, SupportAssistanceKind kind, String query) {}

record SupportAssistanceReceipt(
        UUID ticketId,
        UUID assignmentId,
        UUID requestId,
