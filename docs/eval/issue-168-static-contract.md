...
> 历史 v1 协议留档。2026-08-31 正式分层修订后的当前契约见 [rag-layered-v2](issue-168-layered-v2-contract.md)。以下关于检索层拒答判定、旧 run_query/metrics 的描述仅解释历史版本，不再是新版接线要求；原 ONNX 验收范围完整保留。
