...
2026-09-01 续办：#190已正式交付，当前已同步 main `8bd86e6`，协调授权客服自有源码接线。新的实现、固定 #169 契约、当前未验证项见 [HUMAN 接线记录](../implementation/issue-170-human-wiring.md)。下述截至2026-08-31的范围与阻塞状态是历史记录，不用于声称本轮已测试或仍被#190阻塞。
