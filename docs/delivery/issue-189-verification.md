...
- 数据集 `rag-eval-v1`：60 条查询（36 有答案、12 无答案、12 错误版本或不适用范围）。
...
- 内容哈希 `44c1945d44b842df4b0d43f5db537a8e67fe4ce64019af2239bd92392ee566de`；`original_content_sha256` 相同，纠错账本为空。
