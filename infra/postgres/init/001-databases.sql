...
CREATE ROLE spring_fixture LOGIN PASSWORD 'local-spring-fixture' NOSUPERUSER NOCREATEDB NOCREATEROLE;
...
GRANT CONNECT ON DATABASE customer_agent TO spring_migrator, spring_app, spring_fixture;
GRANT CONNECT ON DATABASE agent_checkpoint TO agent_migrator, agent_runtime;

\connect customer_agent
REVOKE CREATE ON SCHEMA public FROM PUBLIC;
GRANT USAGE ON SCHEMA public TO spring_app, spring_fixture;
